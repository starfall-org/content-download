...
@Client.on_message(
    (
        ((filters.regex("http|https") & filters.regex("youtube.|youtu.be")) & filter_on)
...
@Client.on_message(
    (
        ((filters.regex("http|https") & filters.regex("facebook.|fb.")) & filter_on)
...
@Client.on_message(
    (
        ((filters.regex("http|https") & filters.regex("instagram.")) & filter_on)
        | filters.command("instagram")
    )
    & filters.incoming
    & channel_post
)
...
@Client.on_message(
    (
        ((filters.regex("http|https") & filters.regex("tiktok.|douyin.")) & filter_on)
        | filters.command("facebook")
    )
    & filters.incoming
    & channel_post
...
@Client.on_message(
    ((filters.regex("http://|https://") & filter_on) | filters.command("download"))
    & filters.incoming
    & channel_post
)
